...
export default function OrphanagesMap() {
  ...
  const handleRemoveTutorial = useCallback(() => {
    setTutorial(false)
  }, []);
  ...
  return (
    <>
      {tutorial && (
        <TouchableOpacity style={styles.containerHelp} onPress={handleRemoveTutorial}>
          <Image source={cursorImg} />
          <Text style={styles.textHelp}>Toque no mapa para adicionar um orfanato</Text>
        </TouchableOpacity>
      )}
